...
#
# YOLOAnnotationGenerator.py for Ovarian-Tumor segmentation dataset

# 2024/01/30 : Toshiyuki Arai antillia.com
...
class YOLOAnnotationGenerator:
  ...
  def create_resized_images(self, image_filepath, mask=False):
    ...
    image_512x512 = img.resize((self.W, self.H))
    if mask:
      image_512x512 = self.convert2WhiteMask(image_512x512)
...
./Ovarian-Tumor-ImageMask-Dataset
├─test
├─train
└─valid
...
if __name__ == "__main__":
  try:      
    ...
    input_dir   = "./Ovarian-Tumor-Ultrasound-ImageMask-Dataset"
